...
SECRET_KEY = 'django-insecure-1wkxco5t!lio^f2fv&616$emjr$$-1mjruvb^6k(#pfm9&7s$@'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], # Donde van los html
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_ROOT = BASE_DIR / 'staticfiles' # Carpeta destino exclusivo para servidor real
...
# Ruta donde será redirigido después de iniciar sesión
